...
which button was changed most recently."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, key=Component.UNDEFINED, color=Component.UNDEFINED, pill=Component.UNDEFINED, href=Component.UNDEFINED, tag=Component.UNDEFINED, loading_state=Component.UNDEFINED, external_link=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'key', 'color', 'pill', 'href', 'tag', 'loading_state', 'external_link', 'n_clicks', 'n_clicks_timestamp']
        self._type = 'Badge'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'key', 'color', 'pill', 'href', 'tag', 'loading_state', 'external_link', 'n_clicks', 'n_clicks_timestamp']
