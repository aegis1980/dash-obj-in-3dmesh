...
Those keys have the following types:
  ...
  - component_name (string; optional): Holds the name of the component that is loading"""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, key=Component.UNDEFINED, href=Component.UNDEFINED, external_link=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, active=Component.UNDEFINED, block=Component.UNDEFINED, color=Component.UNDEFINED, disabled=Component.UNDEFINED, size=Component.UNDEFINED, outline=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'style', 'key', 'href', 'external_link', 'n_clicks', 'n_clicks_timestamp', 'active', 'block', 'color', 'disabled', 'size', 'outline', 'loading_state']
        self._type = 'Button'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'style', 'key', 'href', 'external_link', 'n_clicks', 'n_clicks_timestamp', 'active', 'block', 'color', 'disabled', 'size', 'outline', 'loading_state']
